...
CREATE TABLE `Exams` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Exams_Users1_idx` (`user_id`),
  CONSTRAINT `fk_Exams_Users1` FOREIGN KEY (`user_id`) REFERENCES `Users` (`id`)
...
INSERT INTO `Exams` VALUES (1,1,'2002-01-09 00:00:00',1,'printed'),(2,1,'2004-09-09 00:00:00',2,'printed'),(3,1,'2005-07-28 00:00:00',1,'printed'),(4,1,'2008-07-28 00:00:00',3,'online'),(5,1,'2009-04-28 00:00:00',4,'online');
...
--
-- Table structure for table `HealthMetricsCategories`
--

DROP TABLE IF EXISTS `HealthMetricsCategories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `HealthMetricsCategories` (
  `id` int NOT NULL,
...
INSERT INTO `Users` VALUES (1,'Kostas','Tseronis','1977-06-28 00:00:00'),(2,'Louise','Tseronis','1979-01-16 00:00:00');
...
-- Dump completed on 2024-04-07 14:41:38
-- MySQL dump 10.13  Distrib 8.0.31, for macos12 (x86_64)
--
...
-- Dump completed on 2024-04-07 14:41:39
